  ...
  (
    ...
    if (PrefixIcon) {
      ...
      return (
        <input
          ref={ref}
          className={`px-3 py-[3px] text-md w-full bg-transparent border-[1px] border-gray-300 shadow-lg rounded-lg focus:outline-none focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 ${className}`}
          {...rest}
        />
      );
    }
